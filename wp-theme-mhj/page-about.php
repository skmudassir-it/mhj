...
// Hardcoded Team Members from Next.js state
$team_members = array(
        array(
        'name' => 'Jayasri Botcha',
    ...
    <div class="mx-auto max-w-7xl">
        <div class="max-w-3xl space-y-6">
            <h1 class="text-6xl md:text-8xl font-black tracking-tight text-slate-900 dark:text-white uppercase leading-[0.9]">
                About <br /><span class="text-brand-primary">The Jamboree</span>
            </h1>
...
<section class="py-32 px-6">
    <div class="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-20">
        <div class="space-y-8 p-12 rounded-[48px] bg-brand-primary text-white shadow-2xl relative overflow-hidden group">
            <div class="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-[100px] -mr-32 -mt-32"></div>
            <h2 class="text-5xl font-black tracking-tight uppercase italic">Our Mission</h2>
        ...
        <div class="space-y-8 p-12 rounded-[48px] bg-slate-900 text-white shadow-2xl relative overflow-hidden group">
            <div class="absolute top-0 right-0 w-64 h-64 bg-brand-primary/10 rounded-full blur-[100px] -mr-32 -mt-32"></div>
            <h2 class="text-5xl font-black tracking-tight uppercase italic text-brand-secondary">Our Vision</h2>
            ...
            <div class="w-20 h-1 bg-brand-primary rounded-full"></div>
        </div>
    </div>
</section>
...
<section class="py-24 px-6 bg-white dark:bg-slate-950">
    <div class="mx-auto max-w-4xl space-y-10">
        <div class="space-y-4">
            <h2 class="text-4xl md:text-5xl font-black tracking-tight uppercase text-slate-900 dark:text-white">
                Our <span class="text-brand-primary">Story</span>
            </h2>
            <div class="w-20 h-1 bg-brand-primary rounded-full"></div>
        </div>

        <div class="prose prose-lg dark:prose-invert prose-slate max-w-none prose-p:leading-relaxed prose-p:text-slate-600 dark:prose-p:text-slate-400 font-medium space-y-6">
            <p>
            ...
            <p class="text-2xl font-black text-brand-primary italic my-10 py-6 border-l-4 border-brand-primary pl-6">
            ...
            <div class="bg-slate-50 dark:bg-slate-900/50 p-8 rounded-3xl my-10 border border-slate-100 dark:border-slate-800">
                <p class="mb-6 font-bold text-slate-900 dark:text-white">
                ...
                <ul class="space-y-3 list-none p-0 text-slate-700 dark:text-slate-300">
                    <li class="flex items-start gap-3"><span class="text-brand-primary mt-1 font-black shrink-0">&rarr;</span><span>Sensory health zones and cultural experiences</span></li>
                    <li class="flex items-start gap-3"><span class="text-brand-primary mt-1 font-black shrink-0">&rarr;</span><span>Community performances and youth programming</span></li>
                    <li class="flex items-start gap-3"><span class="text-brand-primary mt-1 font-black shrink-0">&rarr;</span><span>Giveaways and wellness incentives</span></li>
                    <li class="flex items-start gap-3"><span class="text-brand-primary mt-1 font-black shrink-0">&rarr;</span><span>Local artists, chefs, and vendors</span></li>
                    <li class="flex items-start gap-3"><span class="text-brand-primary mt-1 font-black shrink-0">&rarr;</span><span>The launch of the OKRA year-round wellness network</span></li>
                    <li class="flex items-start gap-3"><span class="text-brand-primary mt-1 font-black shrink-0">&rarr;</span><span>The CORNBREAD Passport engagement system</span></li>
                    <li class="flex items-start gap-3"><span class="text-brand-primary mt-1 font-black shrink-0">&rarr;</span><span>Safety, accessibility, and operational needs</span></li>
                    <li class="flex items-start gap-3"><span class="text-brand-primary mt-1 font-black shrink-0">&rarr;</span><span>The Crumbs & Culture Tour: a series of activation workshops leading up to the Jamboree that engage the community and raise awareness.</span></li>
                </ul>
            </div>
            ...
            <p class="font-bold text-slate-900 dark:text-white text-xl pt-4">
...
<section class="py-32 px-6 bg-slate-50 dark:bg-slate-900/30">
    <div class="mx-auto max-w-7xl">
        <div class="text-center space-y-4 mb-24">
            <h2 class="text-4xl md:text-6xl font-black tracking-tight uppercase">Meet Our <span class="text-brand-primary">Core Team</span></h2>
            <p class="text-xl text-slate-500 max-w-2xl mx-auto font-medium">The passionate individuals working year-round to build a healthier Memphis.</p>
        </div>
...
<section class="py-32 px-6 text-center">
    <div class="mx-auto max-w-4xl space-y-8">
        <div class="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-10">
            <span class="text-4xl font-serif text-brand-primary">"</span>
        </div>
        <h2 class="text-4xl md:text-5xl font-black tracking-tight leading-tight uppercase italic text-slate-800 dark:text-slate-200">
